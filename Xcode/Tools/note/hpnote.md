...
||B: Bold [On/Off]|FB\1\0 F =  Foreground (COLOR), Background (COLOR)|
||I: Italic [On/Off]|\0\0\1\0 Foreground (BLACK), Background (BLACK)|
||U: Underlined [On/Off]|\0B\1\0 Foreground (BLACK), Background (COLOR)|
||S: Strikethrough [On/Off]|F\0\1\0 Foreground (COLOR), Background (BLACK)|
