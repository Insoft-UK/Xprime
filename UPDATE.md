...
In light of HP Prime Development Tools, Xprime adopts the .hpppl and .hppplplus file types and discontinue .ppl .ppl+ .prgm+. This change will simplify development for those using either Visual Studio Code or Xprime.
